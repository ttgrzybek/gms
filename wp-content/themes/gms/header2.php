    ...
    <div class="container">
        <nav class="main--nav">
            <a href="<?php echo site_url('/'); ?>">
                <img alt="Logo" src="http://www.gms.edu.pl/images/logo.png">
            </a>
            ...
            <ul class="site--nav">
                ...
                <ul>
                    ...
                    <ul>
                        <li><a href="">Wdrożenie standardów sprzedaży</a></li>
                        <li><a href="">Programy rozwoju liderów</a></li>
                        <li><a href="">Akademie sprzedaży</a></li>
                    </ul></li>
                    <li><a href="">Szkolenia</a></li>
                    <li><a href="">Gry biznesowe</a></li>
                    <li><a href="">Coaching</a></li>
                    <li><a href="">Badania</a></li>
                </ul></li>
                <li><a href=""></a>Wiedza</li>
